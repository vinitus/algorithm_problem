const main = require('./1581_락스타락동호');
...
makeTestInstance(`1 2 1 1`, 5);
makeTestInstance(`100 0 0 200`, 100);
makeTestInstance(`0 0 20 200`, 201);
makeTestInstance(`192 279 971 249`, 999);
